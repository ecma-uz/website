                ...
                <div className="mt-16 grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:grid-cols-3">
                    {communities.map((community) => (
                        <FadeIn key={community.id}>
                            <div className="group relative flex flex-col h-full items-start p-8 rounded-3xl bg-white dark:bg-neutral-800/50 shadow-xl shadow-neutral-200/50 dark:shadow-neutral-900/50 hover:shadow-2xl hover:shadow-neutral-200/70 dark:hover:shadow-neutral-900/70 !transition-all duration-400 border-2 border-neutral-200/50 dark:border-neutral-700/50 hover:border-primary/30 dark:hover:border-primary/30 hover:-translate-y-1 overflow-hidden">
                                {community.isNew && (
                                ...
                                <div className="relative h-26 w-26 flex items-center justify-center rounded-2xl bg-gradient-to-br from-neutral-50 to-white dark:from-neutral-800 dark:to-neutral-700 shadow-md group-hover:shadow-lg transition-all duration-400">
                                ...
                                <a
                                    href={community.url}
                                    className="mt-6 inline-flex items-center justify-center w-full px-6 py-3 rounded-xl bg-gradient-to-r from-primary to-accent text-white font-medium hover:from-accent hover:to-primary transition-all duration-400 group/link shadow-lg hover:shadow-xl hover:-translate-y-0.5 hover:brightness-110"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                >
                                    {t.joinButton}
                                    <svg className="ml-2 h-5 w-5 !transition-transform duration-400 group-hover/link:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
